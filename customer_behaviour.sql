...
and purchase ammount > (select avg(purchase_amou))
...
-- Q7. Segment customers into New, Returning and loyal based on their total numbers of previous purchases and show count of each segment
